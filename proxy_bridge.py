...
Bridge mapping (định dạng proxy_real: socks5://USER:PASS@IP:PORT):
  video_1: localhost:11001 → socks5://USER:PASS@IP:PORT
  video_2: localhost:11002 → socks5://USER:PASS@IP:PORT
  video_3: localhost:11003 → socks5://USER:PASS@IP:PORT
  video_4: localhost:11004 → socks5://USER:PASS@IP:PORT
  video_5: localhost:11005 → socks5://USER:PASS@IP:PORT
"""
